...
class Checkers{
    ...
    ******************************************/
    bool whiteMove(pair<int,int> origin, pair<int,int> destination, CELL piece); //function used to determine valid white moves
    bool blackMove(pair<int,int> origin, pair<int,int> destination, CELL piece); //function used to determine valid black moves
};
#endif